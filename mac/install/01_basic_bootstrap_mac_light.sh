...
# ============================================================
# Python 패키지 설치 (pip / pipx)
# ============================================================
echo ""
echo "Python 패키지 설치 중..."

# 1. 시스템 의존성 (cairosvg 등을 위해 필요)
if [[ $(uname -s) == "Darwin" ]]; then
    brew install cairo pkg-config libffi
fi

# 2. 전역 Python 패키지 설치
# cairosvg 및 업무에 필요한 패키지들
python3 -m pip install --upgrade pip
python3 -m pip install cairosvg pandas openpyxl requests
